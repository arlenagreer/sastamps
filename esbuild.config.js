...
const pageConfigs = [
  ...
  {
    entryPoint: 'js/pages/archive.js',
    outfile: 'dist/js/archive.min.js',
    globalName: 'SAPA_ARCHIVE'
  },
  {
    entryPoint: 'js/pages/membership.js',
    outfile: 'dist/js/membership.min.js',
    globalName: 'SAPA_MEMBERSHIP'
  },
  {
