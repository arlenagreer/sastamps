...
${n} at ${a}`,icon:"/favicon.ico",badge:"/favicon.ico",tag:`sapa-meeting-${t.meetingId}`,requireInteraction:!1});r.onclick=()=>{window.focus(),r.close()},setTimeout(()=>r.close(),$.NOTIFICATION_AUTO_CLOSE)}showInPageNotification(t){let n=document.getElementById("reminder-notification");n&&n.remove();let a=document.createElement("div");a.id="reminder-notification",a.className="reminder-notification",a.innerHTML=`
        ...
        `,n=document.createElement("style");n.id="meeting-loader-styles",n.textContent=t,document.head.appendChild(n)}};typeof document!="undefined"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>W.addStyles()):W.addStyles());Ya=W;typeof window!="undefined"&&(window.MeetingLoader=W)});var Pt={};oe(Pt,{CalendarComponent:()=>ve,default:()=>qa});var Ht,ve,qa,Yt=L(()=>{$t();It();Rt();Ot();O();Ht=M("CalendarComponent"),ve=class e{constructor(t,n){this.containerId=t,this.meetingsData=n,this.calendar=null,this.events=[],this.isLazyLoaded=!1,this.isLazyLoaded||this.init()}static async lazyLoad(t,n=null){return new Promise((a,r)=>{try{if(!n)Promise.resolve().then(()=>(Ft(),_t)).then(o=>{let s=o.default;return new s().loadData()}).then(o=>{let s=new e(t.id,o);s.isLazyLoaded=!0,s.init(),a(s)}).catch(r);else{let o=new e(t.id,n);o.isLazyLoaded=!0,o.init(),a(o)}}catch(o){r(o)}})}async init(){try{this.meetingsData&&(this.events=Z.convertToCalendarEvents(this.meetingsData)),this.createCalendar()}catch(t){Ht.error("Error initializing calendar:",t),this.showError("Failed to initialize calendar")}}createCalendar(){let t=document.getElementById(this.containerId);if(!t){Ht.error(`Calendar container with ID "${this.containerId}" not found`);return}t.innerHTML="";let n=document.createElement("div");n.className="calendar-container";let a=document.createElement("div");a.id="vanilla-calendar",a.className="vanilla-calendar",n.appendChild(a),t.appendChild(n),this.createEventLegend(t),this.calendar=new kt(a,{type:"default",settings:{lang:"en",iso8601:!1,selection:{day:"single",month:!0,year:!0},selected:{dates:[],month:new Date().getMonth(),year:new Date().getFullYear()},visibility:{theme:"system",themeDetect:!0,monthShort:!0,weekNumbers:!1,weekend:!0,today:!0,rangeDisabled:!1},range:{min:"1970-01-01",max:"2030-12-31"}},actions:{clickDay:(r,o)=>this.handleDayClick(r,o),changeMonth:(r,o)=>this.handleMonthChange(r,o),changeYear:(r,o)=>this.handleYearChange(r,o)}}),this.calendar.init(),this.updateCalendarEvents(),this.meetingsData&&this.meetingsData.meetings&&Ze.setReminders(this.meetingsData.meetings)}createEventLegend(t){let n=document.createElement("div");n.className="event-indicators",n.innerHTML=`
...
${t.stack||""}</pre>
        ...
        `}},ur=new ie,Se=new Me;O();var Ce=M("SafeDOM");function S(e,t=document){try{return t.querySelector(e)}catch(n){return Ce.warn(`Failed to query selector "${e}":`,n),null}}function Le(e,t=null){try{let n=localStorage.getItem(e);return n!==null?JSON.parse(n):t}catch(n){return Ce.warn(`Failed to get localStorage item "${e}":`,n),t}}function Ae(e,t){try{return localStorage.setItem(e,JSON.stringify(t)),!0}catch(n){return Ce.warn(`Failed to set localStorage item "${e}":`,n),!1}}O();var y=M("Script"),te=new Map;function Bt(e,t){let n;return function(...r){let o=()=>{clearTimeout(n),e(...r)};clearTimeout(n),n=setTimeout(o,t)}}function C(e,t,n,a){e.addEventListener(t,n,a),te.has(e)||te.set(e,[]),te.get(e).push({event:t,handler:n,options:a})}function Ba(){te.forEach((e,t)=>{e.forEach(({event:n,handler:a,options:r})=>{t.removeEventListener(n,a,r)})}),te.clear()}function Wa(e,t=new Date){try{let n=new Date(e);if(isNaN(n.getTime()))throw new Error("Invalid date format");return n}catch(n){return y.error(`Failed to parse date "${e}":`,n),t}}async function Gt(e,t={},n=3){for(let a=0;a<n;a++)try{let r=await fetch(e,t);if(!r.ok)throw new Error(`HTTP ${r.status}: ${r.statusText}`);return r}catch(r){if(a===n-1)throw r;y.warn(`Fetch attempt ${a+1} failed, retrying...`,r),await new Promise(o=>setTimeout(o,1e3*Math.pow(2,a)))}}document.addEventListener("DOMContentLoaded",function(){try{let e=(l,c,d=null)=>new k({componentName:l,container:d,onError:(u,p)=>{y.error(`[${p}] Component failed:`,u),typeof gtag!="undefined"&&gtag("event","exception",{description:`Component failure: ${p}`,fatal:!1})},retryCallback:()=>{try{c()}catch(u){y.error(`[${l}] Retry failed:`,u)}},maxRetries:1}).wrap(c),t=e("Mobile Viewport",za),n=e("Mobile Menu",Ga),a=e("Event Countdown",ja),r=e("Form Validation",Va),o=e("Accordion",Ka),s=e("Theme Toggle",Ja),i=e("Contact Form",jt);t(),n(),a(),r(),o(),s(),i(),nr()}catch(e){y.error("Error during page initialization:",e);let t=document.createElement("div");t.className="error-banner",t.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
        ...
        `,t.textContent="Some features may not work properly. Please refresh the page.",document.body.insertBefore(t,document.body.firstChild),setTimeout(()=>{t.parentNode&&t.parentNode.removeChild(t)},5e3)}});function za(){function e(){let n=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${n}px`)}e();let t=Bt(e,250);if(C(window,"resize",t),C(window,"orientationchange",function(){setTimeout(e,100)}),/iPad|iPhone|iPod/.test(navigator.userAgent)){let n=Bt(e,150);C(window,"scroll",n)}}function Ga(){}function ja(){try{let e=S("#event-countdown");if(!e){y.info("Event countdown element not found - feature not available on this page");return}let t=e.getAttribute("data-event-date");if(!t){y.warn("Event countdown missing data-event-date attribute");return}let a=Wa(t).getTime();if(isNaN(a)){y.error("Invalid event date:",t),e.innerHTML="";let o=x("span",{className:"countdown-error",textContent:"Invalid event date"});e.appendChild(o);return}let r=setInterval(function(){try{let o=new Date().getTime(),s=a-o;if(s<0){clearInterval(r),e.innerHTML="";let p=x("span",{className:"countdown-complete",textContent:"Event is happening now!"});e.appendChild(p);return}let i=Math.floor(s/(1e3*60*60*24)),l=Math.floor(s%(1e3*60*60*24)/(1e3*60*60)),c=Math.floor(s%(1e3*60*60)/(1e3*60)),d=Math.floor(s%(1e3*60)/1e3);e.innerHTML="";let u=(p,v)=>{let E=x("div",{className:"countdown-unit"}),w=x("span",{className:"countdown-number",textContent:String(p)}),N=x("span",{className:"countdown-label",textContent:v+(p!==1?"s":"")});return E.appendChild(w),E.appendChild(N),E};e.appendChild(u(i,"Day")),e.appendChild(u(l,"Hour")),e.appendChild(u(c,"Minute")),e.appendChild(u(d,"Second"))}catch(o){y.error("Error updating countdown display:",o),clearInterval(r),e.innerHTML="";let s=x("span",{className:"countdown-error",textContent:"Countdown error"});e.appendChild(s)}},1e3)}catch(e){y.error("Error setting up event countdown:",e)}}function Va(){try{let e=S("#contact-form");if(!e){y.info("Contact form not found - feature not available on this page");return}C(e,"submit",function(t){var s;t.preventDefault();let n=!0,a=e.querySelectorAll("[required]");e.querySelectorAll(".error-message").forEach(i=>i.remove()),a.forEach(i=>{if(i.classList.remove("error"),!i.value.trim()){n=!1,i.classList.add("error");let l=document.createElement("p");l.classList.add("error-message"),l.textContent="This field is required",i.parentNode.appendChild(l)}});let o=e.querySelector('input[type="email"]');if(o&&o.value.trim()&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(o.value)){n=!1,o.classList.add("error");let l=document.createElement("p");l.classList.add("error-message"),l.textContent="Please enter a valid email address",o.parentNode.appendChild(l)}if(n){let i=e.querySelector('button[type="submit"]'),l=i.textContent;i.disabled=!0,i.textContent="Sending...";let c={name:e.querySelector('[name="name"]').value.trim(),email:e.querySelector('[name="email"]').value.trim(),phone:((s=e.querySelector('[name="phone"]'))==null?void 0:s.value.trim())||"",subject:e.querySelector('[name="subject"]').value.trim(),message:e.querySelector('[name="message"]').value.trim()},d="/contact-handler.php";window.location.hostname.includes("netlify")&&(d="/.netlify/functions/contact-form"),Gt(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(c)}).then(u=>{if(!u.ok)throw new Error(`Server responded with ${u.status}: ${u.statusText}`);return u.json()}).then(u=>{if(u.success){e.style.display="none";let p=document.createElement("div");p.classList.add("success-message");let v=x("h3",{textContent:"Thank you for your message!"}),E=x("p",{textContent:be(u.message||"We've received your inquiry and will respond as soon as possible.")}),w=x("button",{className:"btn btn-primary mt-3",textContent:"Send Another Message"});w.id="send-another",p.appendChild(v),p.appendChild(E),p.appendChild(w),e.parentNode.appendChild(p);let N=document.getElementById("send-another");N&&C(N,"click",function(){e.reset(),p.remove(),e.style.display="block"})}else u.errors&&Object.keys(u.errors).forEach(p=>{let v=e.querySelector(`[name="${p}"]`);if(v){v.classList.add("error");let E=v.parentNode.querySelector(".error-message");E&&E.remove();let w=document.createElement("p");w.classList.add("error-message"),w.textContent=u.errors[p],v.parentNode.appendChild(w)}}),i.disabled=!1,i.textContent=l}).catch(u=>{y.error("Form submission error:",u);let p=document.createElement("div");p.classList.add("error-message","form-error"),p.textContent="An error occurred. Please try again later.",e.insertBefore(p,e.firstChild),i.disabled=!1,i.textContent=l,setTimeout(()=>{p.remove()},5e3)})}})}catch(e){y.error("Error setting up form validation:",e)}}function Ka(){let e=document.querySelectorAll(".accordion-header");e.length&&e.forEach(t=>{C(t,"click",function(){this.classList.toggle("active");let n=this.nextElementSibling;if(n.style.maxHeight){n.style.maxHeight=null;let a=this.querySelector("i");a&&a.classList.replace("fa-chevron-up","fa-chevron-down")}else{n.style.maxHeight=n.scrollHeight+"px";let a=this.querySelector("i");a&&a.classList.replace("fa-chevron-down","fa-chevron-up")}})})}function Qa(){let e=document.querySelectorAll(".gallery-image"),t=document.querySelector(".lightbox");if(!e.length||!t)return;e.forEach(a=>{C(a,"click",function(){let r=this.getAttribute("data-full-img")||this.src,o=this.getAttribute("alt"),s=t.querySelector(".lightbox-img"),i=t.querySelector(".lightbox-caption");s.src=r,i.textContent=o,t.classList.add("active"),document.body.classList.add("no-scroll")})});let n=t.querySelector(".lightbox-close");n&&C(n,"click",function(){t.classList.remove("active"),document.body.classList.remove("no-scroll")}),C(t,"click",function(a){a.target===t&&(t.classList.remove("active"),document.body.classList.remove("no-scroll"))}),C(document,"keydown",function(a){a.key==="Escape"&&t.classList.contains("active")&&(t.classList.remove("active"),document.body.classList.remove("no-scroll"))})}document.querySelectorAll('a[href^="#"]:not([href="#"])').forEach(e=>{C(e,"click",function(t){t.preventDefault();let n=this.getAttribute("href"),a=document.querySelector(n);a&&(a.scrollIntoView({behavior:"smooth"}),history.pushState(null,null,n))})});function Xa(){let e=window.location.pathname.split("/").pop();document.querySelectorAll("nav a").forEach(n=>{let a=n.getAttribute("href");(a===e||e===""&&a==="index.html")&&(n.classList.add("active"),n.setAttribute("aria-current","page"))})}Xa();"serviceWorker"in navigator&&window.location.protocol!=="file:"?window.addEventListener("load",()=>{try{navigator.serviceWorker.register("/sw.js").then(()=>{}).catch(e=>{y.warn("ServiceWorker registration failed:",e)})}catch(e){y.warn("ServiceWorker registration error:",e)}}):"serviceWorker"in navigator?y.info("ServiceWorker not supported on file:// protocol"):y.info("ServiceWorker not supported in this browser");function Ja(){try{let e=Le("theme","light");try{e==="dark"&&document.documentElement.setAttribute("data-theme","dark")}catch(n){y.error("Error applying saved theme:",n)}let t=document.querySelectorAll(".theme-toggle");if(t.length===0){y.info("No theme toggle buttons found");return}t.forEach(n=>{C(n,"click",function(){try{let r=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";r==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme"),Ae("theme",r)||y.warn("Failed to save theme preference");let s=r==="dark"?"Switch to light mode":"Switch to dark mode";t.forEach(i=>i.setAttribute("aria-label",s))}catch(a){y.error("Error toggling theme:",a)}});try{let r=(document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light")==="dark"?"Switch to light mode":"Switch to dark mode";n.setAttribute("aria-label",r)}catch(a){y.error("Error setting initial aria-label:",a)}})}catch(e){y.error("Error setting up theme toggle:",e)}}function jt(){try{let e=S("#contact-form");if(!e)return;Wt(),C(e,"submit",async function(t){t.preventDefault();let n=S("#submit-btn"),a=S("#loading-spinner"),r=S("#form-message");try{if(!Za("contact_form",3,36e5)){r&&(r.innerHTML='<div class="error-message" style="color: var(--danger); background-color: #f8d7da; border: 1px solid #f5c6cb; padding: 1rem; border-radius: var(--radius-md); margin-top: 1rem;"><i class="fas fa-exclamation-triangle"></i> Too many submissions. Please wait before trying again.</div>');return}let o={name:l.name,email:l.email,phone:l.phone,subject:l.subject,message:l.message},s={};if(Object.keys(o).forEach(p=>{if(o[p]){let v=er(o[p],p);v.isValid||(s[p]=v.errors.join(", "))}}),Object.keys(s).length>0){zt(s);return}tr(),r&&(r.innerHTML=""),n&&(n.style.display="none"),a&&(a.style.display="inline-block");let i=new FormData(e),l=Object.fromEntries(i.entries()),c=window.location.hostname.includes("netlify")||window.location.hostname.includes("vercel")?"/.netlify/functions/contact-form":"contact-handler.php",u=await(await Gt(c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)},2)).json();if(u.success){if(r){r.innerHTML="";let p=x("div",{className:"success-message",style:{color:"var(--success)",backgroundColor:"#d4edda",border:"1px solid #c3e6cb",padding:"1rem",borderRadius:"var(--radius-md)",marginTop:"1rem"}}),v=x("i",{className:"fas fa-check-circle"});p.appendChild(v),p.appendChild(document.createTextNode(" "+be(u.message))),r.appendChild(p)}e.reset(),Wt()}else if(u.errors&&zt(u.errors),r&&!Object.keys(u.errors||{}).length){r.innerHTML="";let p=x("div",{className:"error-message",style:{color:"var(--danger)",backgroundColor:"#f8d7da",border:"1px solid #f5c6cb",padding:"1rem",borderRadius:"var(--radius-md)",marginTop:"1rem"}}),v=x("i",{className:"fas fa-exclamation-triangle"});p.appendChild(v),p.appendChild(document.createTextNode(" There was an error sending your message. Please try again.")),r.appendChild(p)}}catch(o){if(y.error("Contact form submission error:",o),r){r.innerHTML="";let s=x("div",{className:"error-message",style:{color:"var(--danger)",backgroundColor:"#f8d7da",border:"1px solid #f5c6cb",padding:"1rem",borderRadius:"var(--radius-md)",marginTop:"1rem"}}),i=x("i",{className:"fas fa-exclamation-triangle"});s.appendChild(i),s.appendChild(document.createTextNode(" Network error. Please check your connection and try again.")),r.appendChild(s)}}finally{n&&(n.style.display="inline-block"),a&&(a.style.display="none")}})}catch(e){y.error("Error setting up contact form:",e)}}function Za(e,t=3,n=36e5){try{let a=`rate_limit_${e}`,r=Date.now(),o=Le(a,[]),i=(Array.isArray(o)?o:[]).filter(l=>r-l<n);return i.length>=t?!1:(i.push(r),Ae(a,i),!0)}catch(a){return y.warn("Rate limiting check failed:",a),!0}}function er(e,t="text"){let n={isValid:!0,sanitized:e,errors:[]};if(!e||e.trim().length===0)return n.isValid=!1,n.errors.push("This field is required"),n;switch(t){case"email":/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)||(n.isValid=!1,n.errors.push("Invalid email format"));break;case"phone":e&&!/^[\d\s\-\(\)\+\.]{10,}$/.test(e)&&(n.isValid=!1,n.errors.push("Invalid phone format"));break;case"text":default:e.length>5e3&&(n.isValid=!1,n.errors.push("Input too long (maximum 5000 characters)")),e.length<2&&(n.isValid=!1,n.errors.push("Input too short (minimum 2 characters)"));break}return n.sanitized=be(e),n}async function Wt(){try{let e=window.location.hostname.includes("netlify")||window.location.hostname.includes("vercel")?"/.netlify/functions/contact-form":"csrf-token.php",n=await(await fetch(e)).json(),a=S("#csrf-token");a&&n.csrf_token&&(a.value=n.csrf_token)}catch(e){y.error("Error fetching CSRF token:",e)}}function zt(e){Object.keys(e).forEach(t=>{let n=S(`#${t}-error`),a=S(`#${t}`);n&&(n.textContent=be(e[t]),n.style.color="var(--danger)",n.style.fontSize="0.875rem",n.style.marginTop="0.25rem"),a&&(a.style.borderColor="var(--danger)")})}function tr(){let e=document.querySelectorAll(".error-message"),t=document.querySelectorAll("#contact-form .form-control");e.forEach(n=>{n.textContent=""}),t.forEach(n=>{n.style.borderColor=""})}function x(e,t={}){let n=document.createElement(e);return t.textContent&&(n.textContent=t.textContent),t.className&&(n.className=t.className),t.style&&Object.assign(n.style,t.style),n}function be(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")}function nr(){try{let e=S("#meeting-schedule-container");if(e){let s=new k({componentName:"Meeting Schedule",container:e,onError:i=>{y.error("[Meeting Schedule] Failed to load:",i)},maxRetries:2})}document.querySelectorAll(".calendar-container, #calendar-container, #meetings-calendar, #calendar").forEach((s,i)=>{s&&Se.observe(s,async l=>{let{CalendarComponent:c}=await Promise.resolve().then(()=>(Yt(),Pt));return await new k({componentName:`Calendar ${i+1}`,container:l,maxRetries:2}).wrapAsync(async()=>await c.lazyLoad(l))()},{maxRetries:2,fallbackContent:l=>`
                        ...
                        `})});let n=S(".search-container, #search-container");if(n){let s=new k({componentName:"Search",container:n,fallbackUI:i=>`
                ...
                `,maxRetries:1})}if(document.querySelectorAll('.newsletter-content, [class*="newsletter"], [id*="newsletter"]').forEach((s,i)=>{(s.dataset.lazy==="true"||s.classList.contains("dynamic-content")||s.querySelector(".loading, .spinner"))&&Se.observe(s,async l=>{let{default:c}=await Promise.resolve().then(()=>(Ut(),qt)),p=(await new c().loadData()).newsletters;p&&p.length>0&&(l.innerHTML=p.map(v=>`
                        ...
                        `,maxRetries:1})}),S("#contact-form")){let s=S("#form-message"),i=new k({componentName:"Contact Form Component",container:s,fallbackUI:l=>`
                ...
                `,maxRetries:2})}document.querySelectorAll('[id*="schedule"], [id*="events"], [class*="loading"]').forEach((s,i)=>{let l=new k({componentName:`Dynamic Content ${i+1}`,container:s,maxRetries:1})})}catch(e){y.error("Error setting up dynamic content boundaries:",e)}}window.addEventListener("beforeunload",Ba);return Zt(ar);})();
