import{c as r}from"./chunk-BUV2MSDD.min.js";var o=r("Pagination"),s=class{constructor(t={}){this.itemsPerPage=t.itemsPerPage||10,this.maxVisiblePages=t.maxVisiblePages||5,this.currentPage=1,this.totalItems=0,this.totalPages=0,this.items=[],this.filteredItems=[],this.callbacks={onPageChange:t.onPageChange||(()=>{}),onRender:t.onRender||(()=>{})},this.containerElement=null,this.paginationElement=null}setData(t,e=null){return this.items=t||[],this.filteredItems=[...this.items],this.totalItems=this.filteredItems.length,e!==null&&(this.itemsPerPage=e),this.calculateTotalPages(),this.currentPage=1,this}filter(t){return typeof t=="function"?this.filteredItems=this.items.filter(t):this.filteredItems=[...this.items],this.totalItems=this.filteredItems.length,this.calculateTotalPages(),this.currentPage=1,this}sort(t){return typeof t=="function"&&this.filteredItems.sort(t),this}getCurrentPageItems(){let t=(this.currentPage-1)*this.itemsPerPage,e=t+this.itemsPerPage;return this.filteredItems.slice(t,e)}goToPage(t){let e=Math.max(1,Math.min(t,this.totalPages));return e!==this.currentPage&&(this.currentPage=e,this.callbacks.onPageChange(this.currentPage,this.getCurrentPageItems()),this.render()),this}nextPage(){return this.goToPage(this.currentPage+1)}prevPage(){return this.goToPage(this.currentPage-1)}firstPage(){return this.goToPage(1)}lastPage(){return this.goToPage(this.totalPages)}setItemsPerPage(t){return this.itemsPerPage=t,this.calculateTotalPages(),this.currentPage=1,this.callbacks.onPageChange(this.currentPage,this.getCurrentPageItems()),this.render(),this}bindTo(t){return typeof t=="string"?this.containerElement=document.querySelector(t):this.containerElement=t,this.containerElement?(this.paginationElement=this.containerElement.querySelector(".pagination-controls"),this.paginationElement||(this.paginationElement=document.createElement("div"),this.paginationElement.className="pagination-controls",this.containerElement.appendChild(this.paginationElement)),this):(o.error("Pagination container not found"),this)}render(){return this.paginationElement?this.totalPages<=1?(this.paginationElement.innerHTML="",this.paginationElement.style.display="none",this):(this.paginationElement.style.display="block",this.paginationElement.innerHTML=this.generatePaginationHTML(),this.attachEventListeners(),this.callbacks.onRender(this.currentPage,this.totalPages,this.getCurrentPageItems()),this):this}generatePaginationHTML(){let t=this.getVisiblePages(),e='<div class="pagination-wrapper">';e+=`
        ...
        `,e=document.createElement("style");e.id="pagination-styles",e.textContent=t,document.head.appendChild(e)}};typeof document!="undefined"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>s.addStyles()):s.addStyles());var h=s;typeof window!="undefined"&&(window.Pagination=s);export{h as default};
